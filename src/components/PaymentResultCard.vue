<template>
  <v-card class="person-result rounded-lg">
    <v-card-title class="my-2"> Person {{ result.id }} </v-card-title>
      ...
      <div class="payment-breakdown">
        ...
        >
          <div class="pa-2">
            ...
            <div class="text-caption text-grey">
              {{ result.electric.overlapDays }} {{ $t('payment_result_card.days_overlap') }}
            </div>
          </div>
        ...
        >
          <div class="pa-2">
            ...
            <div class="text-caption text-grey">
              {{ result.water.overlapDays }} {{ $t('payment_result_card.days_overlap') }}
            </div>
          </div>
        ...
        >
          <div class="pa-2">
            ...
            <div class="text-caption text-grey">
              {{ result.gas.overlapDays }} {{ $t('payment_result_card.days_overlap') }}
            </div>
          </div>
